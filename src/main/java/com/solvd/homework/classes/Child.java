...
public final class Child extends Person{
    ...
    Logger log = new CustomLogger(Child.class.getName()).getInitializedLogger();
    static Logger staticLogger = new CustomLogger(Child.class.getName()).getInitializedLogger();
    static{
